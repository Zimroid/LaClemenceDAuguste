...
{
    // Connexion à la BDD
    public final static String BDD_URL = "jdbc:mysql://localhost:8889/auguste";
    public final static String BDD_LOGIN = "root";
    public final static String BDD_PWD = "root";
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            Server serv = Server.getInstance(ss, jdbc);
            t = new Thread(serv);
            t.start();
        }
        catch (IOException e)
