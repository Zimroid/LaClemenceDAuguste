...
public abstract class Manager
{
    ...
    /**
     * Retourne la connexion à la base de données du manager.
     *
    ...
    /**
     * Prépare une requête à la base de donnée.
     *
     ...
     * @throws SQLException Erreur dans la requête SQL
     */
    protected PreparedStatement queryWithKeys(String query) throws SQLException
    {
